...
extern NSString * const _Null_unspecified SPTAppRemoteContentTypeDefault;
extern NSString * const _Null_unspecified SPTAppRemoteContentTypeNavigation;
extern NSString * const _Null_unspecified SPTAppRemoteContentTypeFitness;
